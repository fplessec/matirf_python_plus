...
def light_palette():
    ...
    # Backgrounds
    # ======================
    palette.setColor(QPalette.Window, QColor("#f2f2f2"))          # fond général
    palette.setColor(QPalette.Base, QColor("#ffffff"))            # champs texte
    palette.setColor(QPalette.AlternateBase, QColor("#ededed"))   # lignes alternées
    ...
    # Selection / Highlight
    # ======================
    palette.setColor(QPalette.Highlight, QColor("#cfd8e3"))       # gris bleuté
